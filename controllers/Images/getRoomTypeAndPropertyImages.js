...
module.exports.getRoomTypeImages = async (req, res) => {
    const getRoomTypeImagesData = await roomTypeImagesModel.findOne({ roomTypeId: req.params.roomTypeId , displayStatus:"1"})
...
module.exports.propertyImages = async (req, res) => {
    const getPropertyImages = await propertyImagesModel.findOne({ propertyId: req.params.propertyId ,displayStatus:"1"})
